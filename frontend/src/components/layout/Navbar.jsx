...
import { Bell, LogOut, Menu, Receipt, Settings, User, X } from "lucide-react";
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-3">
              <a
                href="/dashboard"
                className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors px-4 py-2"
              >
                Dashboard
              </a>
              <a
